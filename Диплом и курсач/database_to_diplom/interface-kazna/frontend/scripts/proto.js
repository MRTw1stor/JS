...
import ExportDates from "./functions/dates/exportDates.js";
import ImportDates from "./functions/dates/importDates.js";
...
document.getElementById("ComputerExportDatesButton").addEventListener("click", () => {
    ExportDates(0)
});

document.getElementById("WriteOfStationsExportDatesButton").addEventListener("click", () => {
    ExportDates(1)
});

document.getElementById("ComputerImportDatesButton").addEventListener("click", async () => {
    await ImportDates()
});