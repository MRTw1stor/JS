...
const ModalRegistration = () => {
    ...
    return (
        <section className={disableModalRegistration ? "modalregistration_close" : null}>
            <div className={disableModalRegistration ? "modalregistration_close" :"modalregistration"}>
                ...
                <div id="otherregistration">
                    <div id="formregistration">
                        ...
                        <div className="otherregistration">
                            ...
                            <div className="inputs">
                                <input id="registrationtelephone" className="registrationinput" type="text" placeholder="Контактный телефон" onChange={(ev) => setPhone(ev.target.value)}/>
                            ...
                            <div className="inputs">
                                <input id="registrationindex" className="registrationinput" type="text" placeholder="Индекс" onChange={(ev) => setIndex(ev.target.value)}/>
