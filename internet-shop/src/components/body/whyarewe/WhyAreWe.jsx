        ...
        <section className="why">
            <div className="whyarewe">
                <div className="whytext">
                    <span id="whytext1">Почему выбирают нас?</span>
                </div>
                <div className="whytitle1">
                    <div className="whyelem">
                        <span id="whytitle">Скидка постоянным <br />клиентам от 5%</span>
                        <div id="elipse1"></div>
                    </div>
                    <div className="whyelem">
                        <span id="whytitle">Предлагаем самые <br /> выгодные цены</span>
                    </div>
                    <div className="whyelem">
                        <span id="whytitle">Наши покупатели всегда <br /> остаются довольны</span>
                        <div id="elipse2"></div>
                    </div>
                    <div className="whyelem">
                        <span id="whytitle">Широкий ассортимент <br /> товаров для всей семьи</span>
                    </div>
                </div>
                <div className="whytitle2">
                    <div className="whyelem">
                        <span id="whytitle">Возможность доставки в <br /> любой город Беларуси </span>
                        <div id="elipse3"></div>
                    </div>
                    <div className="whyelem">
                        <span id="whytitle">Пункты выдачи заказов <br /> рядом с домом</span>
                        <div id="elipse4"></div>
                    </div>
                </div>
            </div>
            <div id="elipse5">
                <img src="./img/Arrow2.svg" alt="arrow" srcset="" id="arrow2"/>
            </div>
            <div id="elipse6">
