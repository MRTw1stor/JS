...
contract Seatransfer {
    ...
    constructor() {
        users.push(
            Users(0x9e975Dd5806E72bAba82B6B0E28c61C016F6515C, true, false, true)
        );
        users.push(
            Users(0xE5cb8CfDB2627aDB08F657Df7d23b08d7CD4047c, true, false, true)
        );
        users.push(
            Users(0xa0E2E0D908aF2BDcb3767B453525932F6d9E8827, false, true, true)
        );
        users.push(
            Users(0x99Cb64ab326a339A7C4fEC23B76BD3105407c5a3, false, true, true)
        );
        users.push(
            Users(
                0x573F001925CA5C61Be508352E5eD784304ac7751,
                false,
                false,
                true
            )
        ...
        users.push(
            Users(
                0xE80De448c42a02cA370A9006F1E7ef6CaC99583e,
                false,
                false,
                true
            )
        ...
        shops.push(
            Shops(
                shops.length,
                0x25f13E7362E1871F6acf7A3F80352fDFBeFc4853,
                "Moskva"
            )
        );
        shops.push(
            Shops(
                shops.length,
                0xEA56e46da2506B45d322bF9053d0AA2e4CBd32e9,
                "Tula"
            )
        );
